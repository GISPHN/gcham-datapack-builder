...
## Additional sources in 1.1.0

- National Land Numerical Information: P28 (2022), P05 (2022), P04 (2020), A27 (2023), P29 (2023), P11 (2022), N07 (2022), N02 (2025), N13 (2024).
- Geospatial Information Authority of Japan: Designated Emergency Evacuation Sites and Designated Shelters, using each prefecture dataset's database update date.
- J-SHIS / NIED: Probabilistic Seismic Hazard Map 2024, all earthquakes, maximum case, `T30_P03_SI`. The plugin may use the official WMS when local vector conversion is unavailable. Original J-SHIS files are not bundled or redistributed by this plugin.
- OpenStreetMap Standard tiles and GSI seamless aerial photo / hillshade XYZ tiles.

Users must comply with the current terms of each source. In particular, A27 can include source-specific municipal conditions, and J-SHIS terms restrict redistribution of original data files.
